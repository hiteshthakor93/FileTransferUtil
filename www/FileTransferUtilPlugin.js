...
module.exports.enableAccessPoint = function(settings, successCallBack, failureCallBack)
{
    exec(successCallBack, failureCallBack, 'FileTransferUtilPlugin', 'enableHostAP', [settings]);
};

module.exports.disableAccessPoint = function(successCallBack, failureCallBack)
{
  exec(successCallBack, failureCallBack, 'FileTransferUtilPlugin', 'disableHostAP',[]);
};
