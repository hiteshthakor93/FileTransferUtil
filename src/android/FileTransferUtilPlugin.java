package cordova.plugin.filetransferutil;
 ...
 */
public class FileTransferUtilPlugin extends CordovaPlugin {

   private static final String LOGTAG = "HotSpotManager";

    /** Cordova Actions.**/
    private static final String ACTION_ENABLE_ACCESS_POINT = "enableHostAP";
    private static final String ACTION_DISABLE_ACCESS_POINT = "disableHostAP";
